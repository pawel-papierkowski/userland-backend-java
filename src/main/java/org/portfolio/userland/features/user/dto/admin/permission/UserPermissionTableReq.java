...
@Schema(description = "Payload required to return page of results from user permissions table. All fields except userId can be null/empty, in this case fields won't be used at all (no filtering) or defaults will be used (tableMeta).")
