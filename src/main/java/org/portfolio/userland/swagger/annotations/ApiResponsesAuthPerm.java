...
/**
 * Swagger annotation to indicate endpoints that require both authentication via JWT token and elevated permissions.
 */
@Target({ElementType.METHOD, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@ApiResponses(value = {
    @ApiResponse(responseCode = "401", description = "User is not authenticated (no token) or token is malformed.",
...
public @interface ApiResponsesAuthPerm {
}
