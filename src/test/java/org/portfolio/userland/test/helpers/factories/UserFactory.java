...
public class UserFactory {
  ...
  private void modifyStatus(User user) {
    ...
    if (EnUserStatus.PENDING.equals(status)) userTokenFactory.genTokenEntry(user, EnTokenType.ACTIVATE, null);
    if (EnUserStatus.ACTIVE.equals(status)) userHistoryFactory.genHistoryEvent(user, EnHistoryWhat.ACTIVATED);
  }
