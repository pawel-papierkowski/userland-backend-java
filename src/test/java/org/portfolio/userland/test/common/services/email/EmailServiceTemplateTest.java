...
public class EmailServiceTemplateTest extends BaseIntegrationTest {
  ...
  @MockitoSpyBean
  private TemplateEngine templateEngine; // Let's spy on real template engine.
  ...
  public void noTemplate() {
    ...
    // Assert: Verify the template engine was completely untouched.
  ...
  public void errUnknownTemplate() {
    ...
    assertThrows(TemplateInputException.class, () -> emailService.sendEmail(emailReq));
  ...
  public void templateSimple() {
    ...
    assertThat(processedReq.messageHtml()).isNotNull();
